...
public class TestVisibilityInElementChooser extends BaseTest {
	...
	public void testVisibilityFilterInElementChooser() throws Exception {
		...
		FailableRunnable runnable = TestUtil.chooseItemInDialog(300, "Another Nested Package", true, existingShells);
		runnables.add(runnable);
		runnable = TestUtil.chooseItemInDialog(runnable, "Nested Package", true, existingShells);
		runnables.add(runnable);
		runnable = TestUtil.chooseItemInDialog(runnable, "Root", true, existingShells);
		runnables.add(runnable);
		runnable = TestUtil.toggleButtonInElementSelectionDialog(0, runnable, "Enable visibility filter", existingShells);
		runnables.add(runnable);
		runnable = TestUtil.chooseItemInDialog(runnable, "Another Nested Package", true, existingShells);
		runnables.add(runnable);
		runnable = TestUtil.chooseItemInDialog(0, runnable, "Nested Package", true, true, existingShells);
		runnables.add(runnable);
		runnable = TestUtil.chooseItemInDialog(runnable, "Root", true, existingShells);
		runnables.add(runnable);
		runnable = TestUtil.toggleButtonInElementSelectionDialog(0, runnable, "Enable visibility filter", existingShells);
		runnables.add(runnable);
		runnable = TestUtil.chooseItemInDialog(0, "Another Nested Package", true, existingShells);
		runnables.add(runnable);
		runnable = TestUtil.chooseItemInDialog(runnable, "Nested Package", true, existingShells);
		runnables.add(runnable);
		runnable = TestUtil.chooseItemInDialog(runnable, "Root", true, existingShells);
